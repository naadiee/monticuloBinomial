...
private:
    ...
    static void binomialLink(Nodo<T>* y, Nodo<T>* z){
        ...
        z->setGrado(z->getGrado() + 1); // incrementamos en uno el grado de z
    }
    ...
    MonticuloBin<T>* merge(MonticuloBin<T>* h2){
        ...
        if(this->_head->getGrado() >= h2->_head->getGrado()){
...
public:
    ...
    static MonticuloBin<T>* join(MonticuloBin<T>* h1, MonticuloBin<T> h2){
        ...
        if(mergeMon){
            ...
            while(act){
                ...
                if((grado1 == grado2) && (grado2 != sig->getHermanos()->getGrado())){
                    /*
    ...
    void insertar(T key){
        ...
        this->_head = monticulo_resul;
        this->_minimum = monticulo_resul->_minimum;
    }
